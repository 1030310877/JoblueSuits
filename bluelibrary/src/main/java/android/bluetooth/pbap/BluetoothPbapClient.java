 ...
 */
public class BluetoothPbapClient implements ClientAction<ArrayList<VCardEntry>> {
    ...
    @Override
    public void notifyResult(ArrayList<VCardEntry> result) {
        if (listener != null) {
     ...
     * @return <code>true</code> if request has been sent successfully;
     * <code>false</code> otherwise; upon completion PCE sends
     * {@link #EVENT_PULL_VCARD_ENTRY_DONE} or
     ...
     * @return <code>true</code> if request has been sent successfully;
     * <code>false</code> otherwise; upon completion PCE sends
     * {@link #EVENT_PULL_VCARD_ENTRY_DONE}
     * @link #EVENT_PULL_VCARD_ERROR} in case of failure
     */
